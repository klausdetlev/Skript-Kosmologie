...
\begin{figure}[H]
	\begin{multicols}{2}
		\begin{figure}[H]
			\begin{tikzpicture}
				\draw (-0.2,0.1)--(0,0)coordinate(M)--(0.2,0.1)(M)--++(0,-0.2)coordinate(S)--++(-0.1,-0.2)(S)--++(0.1,-0.2)(M)--++(0,0.1)++(0,0.15)circle(1.5mm)++(-0.05*3/4,0.05*3/4)coordinate(A1)++(3/4*0.1,0)coordinate(A2)++({3/4*0.15*cos(225)-3/4*0.05},{3/4*0.15*sin(225)})arc(225:315:3/4*0.15cm);
				\draw[blue!50!black,fill=blue!50!black] (A1)circle(3/4*0.5pt)(A2)circle(3/4*0.5pt);
				\draw (5,5)circle(1cm);
